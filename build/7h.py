...
bottleneckbw2=10
nonbottlebw=100  
buffer_size =bottleneckbw2*1000*30/(1500*8) 
...
net.addLink(r1,r2,intfName1='r1-eth1',intfName2='r2-eth0',cls=TCLink , bw=bottleneckbw2, delay='10ms',loss=5,max_queue_size=buffer_size)
...
net.addLink(r1,r3,intfName1='r1-eth2',intfName2='r3-eth0',cls=TCLink , bw=bottleneckbw1, delay='10ms',loss=5,max_queue_size=buffer_size)
net.addLink(r3,r4,intfName1='r3-eth1',intfName2='r4-eth2',cls=TCLink , bw=nonbottlebw, delay='10ms', max_queue_size=buffer_size*10)
